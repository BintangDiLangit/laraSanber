    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Update Pertanyaan ID : {{ $questions->id }} </h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="/home">Home</a></li>
                            <li class="breadcrumb-item"><a href="/questions">List Pertanyaan</a></li>
                            <li class="breadcrumb-item"><a href="/questions/{{ $questions->id }}">Details Pertanyaan</a>
                            </li>
                ...
                <form action="/questions/{{ $questions->id }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="isi" id="isi" class="form-control my-editor"
                            placeholder="Tulis isi detail pertanyaan disini !" rows="8">{{ $questions->isi }}</textarea>
                    </div>
